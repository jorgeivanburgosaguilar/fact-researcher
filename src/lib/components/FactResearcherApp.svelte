...
{#if savedDraft}
  <section
    class="mx-auto mt-5 max-w-3xl border border-blue-700 bg-blue-50 p-5 text-slate-900"
  ...
  >
    ...
    <div class="mt-4 flex flex-wrap gap-3">
      ...
      <button
        type="button"
        class="rounded-md border border-slate-500 px-3 py-2 text-sm font-semibold focus-visible:ring-2 focus-visible:ring-blue-700 focus-visible:outline-none"
...
{#if storageNotice}
  <p
    class="mx-auto mt-4 max-w-3xl border-l border-amber-700 bg-amber-50 px-4 py-3 text-sm text-amber-950"
    role="status"
    aria-live="polite"
  >
...
{#if reviewedDocument}
  ...
  />
{:else}
  <FileImporter onfile={importFile} error={importError} />
{/if}
